...
public class TouchListener implements View.OnTouchListener {
	...
	private static final int SWIPE_THRESHOLD_VELOCITY = 10;//25;
	private static final int MOVE_THRESHOLD = 200;//250;
	...
	public TouchListener(GameView view, Context ctxt) {
		super();
		this.mContext = ctxt;
		this.mView = view;
	...
	public boolean onTouch(View view, MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (!hasMoved) {
				...
				} else if (iconPressed(mView.sXSettings, mView.sYIcons)) {

					mView.setOptionMenuCalled();				
	...
	public  void showSettingsDialog(final Context mContext) {}
